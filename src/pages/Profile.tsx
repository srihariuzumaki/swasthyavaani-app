    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted pb-20">
      ...
      <div className="bg-gradient-to-br from-primary via-accent to-secondary p-6 pt-8 rounded-b-3xl shadow-[var(--shadow-medical)]">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">{user?.name || t("profile.title", { defaultValue: "Profile" })}</h1>
      ...
      <div className="px-4 mt-6 space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-colors">
              <div className="flex-1">
                <p className="text-sm text-muted-foreground mb-1">{t("profile.name", { defaultValue: "Name" })}</p>
                <p className="font-medium">{user?.name || "Not set"}</p>
              </div>
              <Button
                variant="ghost"
                size="icon"
                onClick={() => toast.info(t("common.editComingSoon", { defaultValue: "Edit profile coming soon!" }))}
              >
            ...
            {user?.email && (
              <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-colors">
                <div className="flex-1">
                  <p className="text-sm text-muted-foreground mb-1">{t("profile.email", { defaultValue: "Email" })}</p>
                  <p className="font-medium">{user.email}</p>
                </div>
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => toast.info(t("common.editComingSoon", { defaultValue: "Edit email coming soon!" }))}
                >
                  <ChevronRight className="w-4 h-4" />
                </Button>
              </div>
            ...
            {user?.phone && (
              <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-colors">
                <div className="flex-1">
                  <p className="text-sm text-muted-foreground mb-1">{t("profile.phoneNumber", { defaultValue: "Phone Number" })}</p>
                  <p className="font-medium">{user.phone}</p>
                </div>
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => toast.info(t("common.editComingSoon", { defaultValue: "Edit phone coming soon!" }))}
                >
                  <ChevronRight className="w-4 h-4" />
                </Button>
              </div>
        ...
        {/* Accessibility */}
        <Card className="p-4">
          <h2 className="font-semibold mb-4">{t("profile.accessibility", { defaultValue: "Accessibility Settings" })}</h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Moon className="w-4 h-4 text-primary" />
                <div>
                  <p className="font-medium">{t("profile.darkMode", { defaultValue: "Dark Mode" })}</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-medium">{t("profile.largeText", { defaultValue: "Large Text" })}</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-medium">{t("profile.highContrast", { defaultValue: "High Contrast" })}</p>
